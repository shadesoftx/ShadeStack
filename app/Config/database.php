...
return [
    ...
    'connections' => [
        ...
        'mysql_testing' => [
            ...
            'host'           => '127.0.0.1',
            'database'       => env('MYSQL_DATABASE', env('DB_DATABASE', 'bookstack-test')),
            'username'       => env('MYSQL_USER', env('DB_USERNAME', 'bookstack-test')),
            'password'       => env('MYSQL_PASSWORD', env('DB_PASSWORD', 'bookstack-test')),
            'port'           => $mysqlPort,
            'charset'        => 'utf8mb4',
            'collation'      => 'utf8mb4_unicode_ci',
            'prefix'         => '',
